...
const timeline: TimelineEntry[] = [
  {
    ...
    type: "Work",
    summary:
      "Backend services and applied AI for production document workflows, with a hard requirement that invalid data never reaches storage.",
    impact: [
      "Piloted the validation-first OCR pipeline: OpenCV normalisation plus four-layer validation gates at the API boundary, ending silent character-swap errors in downstream ledgers.",
      "Built the grounded RAG assistant: deterministic FAISS indices with conservative retrieval gating, giving cited answers or explicit refusals — never fabrications.",
      "Locked environments to pinned lockfiles and instituted structured telemetry, making every deploy reproducible and every workflow decision auditable.",
    ],
    stack: ["Python", "TypeScript", "OpenCV", "FAISS", "Docker", "PostgreSQL", "CI/CD"],
  },
  {
